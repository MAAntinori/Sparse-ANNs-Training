...
def create_data_generators(batch_size=16):
    train_dir = r'\\user.unibz.it\\unibzredir\\mantinori\\Desktop\\ANNs\\Data\\Malaria dataset split - training and testing\\Training_data_cell'
    test_dir = r'\\user.unibz.it\\unibzredir\\mantinori\\Desktop\\ANNs\\Data\\Malaria dataset split - training and testing\\Testing_data_cells'
...
def train_and_evaluate_models():
    ...
    models = ['1', '2']  # Model choices (1: CNN, 2: DenseNet, 3: ResNet)
    sparsity_levels = [0.0, 0.70]
...
# Record the end time
    ...
    # Save the execution time to the DataFrame
                    ...
                    result= {
                            ...
                            'Inference Energy Consumption': inference_energy 
                        }
                    results_list.append(result)
                    results_df = pd.DataFrame(results_list)
                                # Define the Excel file name
                    file_name = 'test_energy_consumption_function_model_results_8x8_epochs.xlsx'

                                # Define the file path
                    file_path = os.path.join(r'\\user.unibz.it\unibzredir\mantinori\Desktop\ANNs\Results', file_name)
