            ...
            for quantize_model in [True, False]:
                for num_epochs in epochs_to_try:
                    ...
                    if model_choice == '1':
                        ...
                        model_name = "DenseNet"
                        model = create_densenet(input_shape=(32, 32, 3), num_classes=1, num_layers_per_block=[4, 4, 4], growth_rate=12, compression_factor=0.5)
                    elif model_choice == '3':
                        model_name = "ResNet"
...
# Record the end time
    ...
    # Save the execution time to the DataFrame
                    ...
                    file_name = 'test_memory_consumption_model_results_32x32_epochs.xlsx'
